...
//***************************************************************************************
.define C_IO_EVENT_NUM    	  3                      // IO number for IO_Event.
...
//	[P_AUDIO_CH1_Data] = R4;
	.external R_Mixer_CH2_DacOutData
	[R_Mixer_CH2_DacOutData] = R4;
	retf;
	.endp
...
//	R2 = C_SpeechDataOffsetHigh
//	R1 = R1 lsl 1;		// count by word
//	R1 += C_SpeechNumberLength;
//	R1 += C_SpeechDataOffsetLow
//	R2 += 0, CARRY
//	
//	push R1, R2 to [SP]
...
//	R3 = R3 ror 1;
//	R4 = R4 lsr 1;
//	R3 += C_SpeechDataOffsetLow;
//	R4 += C_SpeechDataOffsetHigh, carry;
//	[R_ExtMem_Low_Con] = R3;
