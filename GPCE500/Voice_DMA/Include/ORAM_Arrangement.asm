...
OVERLAP_MIXER_CH2_DECOUT_RAM_BLOCK:		.section 	.ORAM 	,.addr = 0x10 + 0x103
R_OVERLAP_MIXER_CH2_DECOUT_RAM_BLOCK: 	.DW 	0x140		DUP(?)
...
OVERLAP_MIXER_CH2_RAM_BLOCK:			.section 	.ORAM 	,.addr = 0x10 + 0x103 + 0x280 + 0x3 + 0x5 + 0x3E + 0xB5 + 0x14C
R_OVERLAP_MIXER_CH2_RAM_BLOCK:			.DW 	0x284	DUP(?)
OVERLAP_A34Pro_fptr_API_BLOCK:			.section 	.ORAM 	,.addr = 0x10 + 0x103 + 0x280 + 0x3 + 0x5 + 0x3E + 0xB5 + 0x14C + 0x284
R_OVERLAP_A34Pro_fptr_API_BLOCK:		.DW 	0x16	DUP(?)
OVERLAP_A34Pro_fptr_EVENT_BLOCK:		.section 	.ORAM 	,.addr = 0x10 + 0x103 + 0x280 + 0x3 + 0x5 + 0x3E + 0xB5 + 0x14C + 0x284 + 0x16
