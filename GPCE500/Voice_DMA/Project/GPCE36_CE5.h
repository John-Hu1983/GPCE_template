...
//====================================================================================
// P_SPU_Chx_PhaseAdder (0x28x0)
//====================================================================================
// Bit[15:0]: Phase count, reserved for hardware.

//====================================================================================
// P_SPU_Chx_SampleFreq (0x28x1)
//====================================================================================
// Bit[15:0]: Sample rate
#define C_SPU_SR_8K					((8000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_10K				((10000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_12K 				((12000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_16K				((16000.0 / (81920000 / 2))) * (1UL << 24)
#define C_SPU_SR_20K				((20000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_24K				((24000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_28K 				((28000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_32K				((32000.0 / (81920000 / 2))) * (1UL << 24)
#define C_SPU_SR_36K				((36000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_40K				((40000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_48K 				((48000.0 / (81920000 / 2))) * (1UL << 24)
#define	C_SPU_SR_64K				((64000.0 / (81920000 / 2))) * (1UL << 24)
#define C_SPU_SR_96K				((96000.0 / (81920000 / 2))) * (1UL << 24)

//====================================================================================
// P_SPU_Chx_DPTR_L (0x28x2)
// P_SPU_Chx_NextDPTR_L (0x28x8)
//====================================================================================
// Bit[15:0]: Address_L

//====================================================================================
// P_SPU_Chx_DPTR_H (0x28x3)
// P_SPU_Chx_NextDPTR_H (0x28x9)
//====================================================================================
// Bit[15:14]: Format
#define C_SPU_Format_A34Pro4		0x0000
#define C_SPU_Format_A34Pro5		0x4000
#define C_SPU_Format_PCM8			0x8000
#define C_SPU_Format_PCM16			0xC000
// Bit[13]: Jump Mode
#define C_SPU_Jump_Relative			0x0000
#define C_SPU_Jump_Absolute			0x2000
// Bit[12:11]: Reserved
// Bit[10:0]: Address_H

//====================================================================================
// P_SPU_Chx_LoopLength (0x28x4)
//====================================================================================
// Bit[15:0]: Loop Length

//====================================================================================
// P_SPU_Chx_Filter_S2 (0x28x5)
//====================================================================================
// Bit[15:0]: S2

//====================================================================================
// P_SPU_Chx_Filter_S1 (0x28x6)
//====================================================================================
// Bit[15:0]: S1

//====================================================================================
// P_SPU_Chx_Volume_Ctrl (0x28x7)
//====================================================================================
// Bit[15:8]: Next Volume
// Bit[7:0]: Volume
