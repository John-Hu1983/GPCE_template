...
.external F_SpuIrqSpeechService
.external F_MIDI_DataCounter
...
_IRQ3:
	push R1, R5 to [SP]
	tstb [P_INT_Status], C_IRQ3_DMA1_NUM
	je L_Exit?
	.external F_ISR_DMA_Ser_SACM_Mixer_Ch2
	call F_ISR_DMA_Ser_SACM_Mixer_Ch2
	R1 = C_DMA1_TX_Done_Flag;
    [P_DMA_INTSTS] = R1;
L_Exit?:	
